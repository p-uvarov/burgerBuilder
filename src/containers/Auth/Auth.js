...
class Auth extends Component {
    ...
    inputChangedHandler = (event, inputElementID) => {
        const updatedAuthForm = {
            authForm: updateObject(this.state.authForm, {
                [inputElementID]: updateObject(this.state.authForm[inputElementID], {
                    value: event.target.value,
                    valid: checkValidity(event.target.value, this.state.authForm[inputElementID].validation),
                    touched: true
                })
            })
        };
